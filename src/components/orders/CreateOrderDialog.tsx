...
type CreateOrderDialogProps = {
  ...
  onCreate: (draft: NewOrderDraft) => void | Promise<void>;
};
              ...
              <div className="grid min-w-0 gap-3 md:grid-cols-6">
                <div className="space-y-1 md:col-span-5">
                  ...
                  <Input
                    ...
                    aria-describedby={errors.item ? "new-order-item-error" : undefined}
                    {...register("item", {
                  ...
                  />
                  {errors.item && (
                    <p id="new-order-item-error" className="text-sm text-destructive" role="alert">
                      {errors.item.message}
                    </p>
                  )}
                </div>
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    aria-describedby={errors.quantity ? "new-order-quantity-error" : undefined}
                    {...register("quantity", {
                      required: REQUIRED_MSG,
                      validate: (v) => {
                ...
                <div className="space-y-1 md:col-span-6">
                  ...
                  <Input
                    ...
                    aria-describedby={
                      errors.purchaseDate ? "new-order-purchase-date-error" : undefined
                    }
                ...
                <div className="min-w-0 space-y-1 md:col-span-3">
                  ...
                  <Input
                    ...
                    aria-describedby={errors.buyer ? "new-order-buyer-error" : undefined}
                    {...register("buyer", {
                      required: REQUIRED_MSG,
                      validate: (v) => v.trim() !== "" || REQUIRED_MSG,
                    })}
                  ...
                  />
                  {errors.buyer && (
                    <p id="new-order-buyer-error" className="text-sm text-destructive" role="alert">
              ...
              <div className="grid min-w-0 gap-3 md:grid-cols-3">
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    aria-describedby={errors.cost ? "new-order-cost-error" : undefined}
                    {...register("cost", {
                      validate: (v) => {
                        const s = String(v ?? "").trim();
                        if (s === "") return true;
                        return Number.isFinite(Number.parseFloat(s)) || "請輸入有效的數字";
                      },
                    })}
                    placeholder="成本"
                    aria-label="成本"
                  />
                  {errors.cost && (
                    <p id="new-order-cost-error" className="text-sm text-destructive" role="alert">
                      {errors.cost.message}
                    </p>
                  )}
                </div>
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    aria-describedby={errors.price ? "new-order-price-error" : undefined}
                    {...register("price", {
                      validate: (v) => {
                        const s = String(v ?? "").trim();
                        if (s === "") return true;
                  ...
                  />
                  {errors.price && (
                    <p id="new-order-price-error" className="text-sm text-destructive" role="alert">
